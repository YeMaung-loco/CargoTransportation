...
public class Office_view {
	...
	private void setProperties() {
		...
		frame.setBounds(10, 10, 1344, 800);
		...
		lblIcon.setIcon(new ImageIcon("D:\\KMD\\icon\\testLogo.png"));
		...
		lbl_iconLogout.setIcon(new ImageIcon("C:\\Users\\User\\Downloads\\logout (1).png"));
