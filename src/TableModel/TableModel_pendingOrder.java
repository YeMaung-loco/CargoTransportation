...
public class TableModel_pendingOrder extends AbstractTableModel {
	...
	public TableModel_pendingOrder(List<Order>list,JButton btn_viewDetail) {
		orderList=list;
		this.btn_viewdetail=btn_viewDetail;
	}

	public TableModel_pendingOrder() {
