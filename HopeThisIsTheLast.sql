...
CREATE TABLE `order` (
  ...
  CONSTRAINT `order_customerid` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`customer_id`),
...
CREATE TABLE `package` (
  ...
  KEY `package_order_idx` (`order_id`),
  KEY `package_weight_idx` (`weightPrice_id`),
  CONSTRAINT `package_order` FOREIGN KEY (`order_id`) REFERENCES `order` (`order_id`),
...
INSERT INTO `staff` VALUES (1,'Ye Maung Maung','09763774399','BoTaHtaung','1/TTT()018894',5,2,_binary '\0',NULL),(2,'Thandar Soe','0923424534','Hle Dan','1/t()23445',4,4,_binary '','2022-07-11');
...
-- Dump completed on 2022-07-11 21:52:51
